...
if (process.argv.length < 5) {
    console.log('Usage: node HTTP-COOKIE.js <target> <time> <useragents.txt>');
    process.exit(1);
}
...
function randomCookie() {
    return 'session=' + Math.random().toString(36).substring(2, 18) + '; id=' + Math.random().toString(36).substring(2, 10);
}
